 ...
 * folder concatenating them all to lib/postgresql/grammar.ne, so it can be
 * later compiled to grammar.js by nearleyc.
 *
 * It is also responsible for copying the dictionary and shared folder to
 * lib/postgresql folder (so it can be read by the compiled grammar files).
 */
 ...
 */
import keywords from '../../src/postgresql/language/dictionary/keywords';
 ...
 * Input.
 */
const langFolder = join(projectRoot, 'src', 'postgresql', 'language');
